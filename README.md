...
# 📖 Decode morse code using ruby <a name="about-project"></a>

- This project about decoding a morse code message using ruby
...
```sh
  ...
  git clone git@github.com:mnaibei/decode-morse-code.git
  cd vet_clinic
